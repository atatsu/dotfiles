...
if version >= 700
  hi CursorLine    guibg=#202020 ctermbg=none
  "hi CursorLine    guibg=#202020 ctermbg=234
  hi CursorColumn  guibg=#202020 ctermbg=none
  "hi CursorColumn  guibg=#202020 ctermbg=234
  hi MatchParen    guifg=#d0ffc0 guibg=#202020 gui=bold ctermfg=157 ctermbg=none cterm=bold
  "hi MatchParen    guifg=#d0ffc0 guibg=#202020 gui=bold ctermfg=157 ctermbg=237 cterm=bold
  hi Pmenu 		   guifg=#ffffff guibg=#202020 ctermfg=255 ctermbg=none
  "hi Pmenu 		   guifg=#ffffff guibg=#202020 ctermfg=255 ctermbg=238
  hi PmenuSel 	   guifg=#000000 guibg=#b1d631 ctermfg=0 ctermbg=none
...
hi NonText 		   guifg=#404040 guibg=#202020 gui=none ctermfg=237 ctermbg=none
"hi NonText 		   guifg=#808080 guibg=#202020 gui=none ctermfg=244 ctermbg=235
hi LineNr 		   guifg=#303030 guibg=#202020 gui=none ctermfg=244 ctermbg=none
...
"hi StatusLineNC    guifg=#939395 guibg=#303030 gui=none ctermfg=246 ctermbg=none
hi StatusLineNC    guifg=#939395 guibg=#303030 gui=none ctermfg=246 ctermbg=238
hi VertSplit 	   guifg=#444444 guibg=#303030 gui=none ctermfg=238 ctermbg=none
hi Folded 		   guibg=#384048 guifg=#a0a8b0 gui=none ctermbg=4 ctermfg=248
hi Title		   guifg=#f6f3e8 guibg=NONE	gui=bold ctermfg=254 cterm=bold
hi Visual		   guifg=#faf4c6 guibg=#3c414c gui=none ctermfg=254 ctermbg=4
hi SpecialKey	   guifg=#404040 guibg=#343434 gui=none ctermfg=237 ctermbg=none
...
hi Function 	   guifg=#ffff00 gui=none ctermfg=255 cterm=bold
...
hi javaScriptFunction ctermfg=200 ctermbg=none cterm=none guifg=#66d9ef guibg=none gui=italic
